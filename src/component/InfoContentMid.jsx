                        ...
                        <div className="rmctt3-in">
                                ...
                                <div className="rmctt3-in2-in">
                                    <div className="rmctt3-in2-in1">
                                        ...
                                        <div className="rmctt3-in2-in12">
                                            <div className="rmctt3-in2-in12-1">디자이너:</div>
                                    ...
                                    <div className="rmctt3-in2-in1">
                                        ...
                                        <div className="rmctt3-in2-in12">
                                            <div className="rmctt3-in2-in12-1">언론 소개:</div>
                                            <div className="rmctt3-in2-in12-2">Condé Nast Traveler, October 2019</div>
                                    ...
                                    <div className="rmctt3-in2-in1">
                                        ...
                                        <div className="rmctt3-in2-in121">
                                            <div className="rmctt3-in2-in12-1">1월 20일 전까지 무료로 취소하실 수 있습니다.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="rmctt3-in3">
                                <div className="rmctt3-in3-in">
                                    <div className="rmctt3-in3-in1">
                                        <img className="l1li2ovm dir dir-ltr" src="https://a0.muscache.com/im/pictures/51a7f002-b223-4e05-a2af-0d4838411d92.jpg" alt="에어커버"/>
                                    </div>
                                    <div className="rmctt3-in3-in2">
                                        모든 예약에는 호스트가 예약을 취소하거나 숙소 정보가 정확하지 않은 경우 또는 체크인에 문제가 있는 상황에 대비한 무료 보호 프로그램이&nbsp;포함됩니다.
                                    </div>
                                    <button className="rmctt3-in3-in3">더 알아보기</button>
                            ...
                            <div className="rmctt3-in4">
                                <div className="rmctt3-in4-in">
                                    ...
                                    <div className="rmctt3-in4-in2">일부 정보는 자동 번역되었습니다.</div>
                                    <button className="rmctt3-in4-in3">원문 보기</button>
                                </div>
                            </div>
                            ...
                            <div className="rmctt3-in7">
                                <div className="rmctt3-in7-in">
                                    ...
                                    <div className="rmctt3-in7-in2">
                                        ...
                                        <div className="rmctt3-in7-inner1">
                                            <div className="rmctt3-in7-inner1-div">
                                                <div style={{textDecoration: "line-through"}}>일산화탄소 경보기</div>
                                                <div className="rmctt3-in7-inner1-div2">
                                                <Facilities9 />
                                                </div>
                                            </div>
                                        ...
                                        <div className="rmctt3-in7-inner1">
                                            <div className="rmctt3-in7-inner1-div">
                                                <div style={{textDecoration: "line-through"}}>화재경보기</div>
                                                <div className="rmctt3-in7-inner1-div2">
                                                <Facilities10 />
                                                </div>
                                            </div>
                                    ...
                                    <div className="rmctt3-in7-in3">
                                        <button type="button" className="rmctt3-in7-in3-btn">편의시설 20개 모두 보기</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="rmctt3-inff">
                                    <section>
                                        <div className="rmctt3in">
                                            <span style={{marginTop: "5px", display: "inline", marginRight: "8px", width: "16px", height: "16px"}}>
                                                <Star />
                                            </span>
                                            ...
                                            <div className="rmctt3-in2-in2">
                                                <div className="rmctt3in2">
                                                    <div className="rmctt3in2-f">
                                                        <div style={{marginBottom: "16px"}}>
                                                            <div className="rmctt3in2-fin">
                                                                <div className="rmctt3in2-fin-txt">청결도</div>
                                                                <div className="rmctt3in2-fin-div">
                                                                    <div className="_7pay" aria-label="5.0점 만점에 4.8점" role="img">
                                                    ...
                                                    <div className="rmctt3in2-f">
                                                        <div style={{marginBottom: "16px"}}>
                                                            <div className="rmctt3in2-fin">
                                                                <div className="rmctt3in2-fin-txt">정확성</div>
                                                                <div className="rmctt3in2-fin-div">
                                                                    <div className="_7pay" aria-label="5.0점 만점에 4.8점" role="img">
                                                                        <span className="_1wsvxly" style={{width: "96%"}}>
                                                                        </span>
                                                    ...
                                                    <div className="rmctt3in2-f">
                                                        <div style={{marginBottom: "16px"}}>
                                                            <div className="rmctt3in2-fin">
                                                                <div className="rmctt3in2-fin-txt">의사소통</div>
                                                                <div className="rmctt3in2-fin-div">
                                                                    <div className="_7pay" aria-label="5.0점 만점에 4.8점" role="img">
                                                                        <span className="_1wsvxly" style={{width: "96%"}}>
                                                                        </span>
                                                    ...
                                                    <div className="rmctt3in2-f">
                                                        <div style={{marginBottom: "16px;"}}>
                                                            <div className="rmctt3in2-fin">
                                                                <div className="rmctt3in2-fin-txt">위치</div>
                                                                <div className="rmctt3in2-fin-div">
                                                                    <div className="_7pay" aria-label="5.0점 만점에 4.8점" role="img">
                                                                        <span className="_1wsvxly" style={{width: "96%"}}>
                                                                        </span>
                                                    ...
                                                    <div style={{marginBottom: "16px;"}}>
                                                            <div className="rmctt3in2-fin">
                                                                <div className="rmctt3in2-fin-txt">체크인</div>
                                                                <div className="rmctt3in2-fin-div">
                                                                    <div className="_7pay" aria-label="5.0점 만점에 4.8점" role="img">
                                                                        <span className="_1wsvxly" style={{width: "96%"}}>
                                                                        </span>
                                                    ...
                                                    <div style={{marginBottom: "16px;"}}>
                                                            <div className="rmctt3in2-fin">
                                                                <div className="rmctt3in2-fin-txt">가격 대비 만족도</div>
                                                                <div className="rmctt3in2-fin-div">
                                                                    <div className="_7pay" aria-label="5.0점 만점에 4.8점" role="img">
                                                                        <span className="_1wsvxly" style={{width: "96%"}}>
                                                                        </span>
                                        ...
                                        <div className="rmctt3-in2">
                                                    ...
                                                    <div style={{marginBottom: "40px"}}>
                                                        <div className="rmc3-in3f">
                                                            ...
                                                            <div className="rmc3fs">
                                                                ...
                                                                <div className="rmc3fs-date"> 2020년 10월</div>
                                                            </div>
                                                        </div>
                                                        <div className="rmc3-ins">
                                                            <div style={{lineHeight: "24px"}}>
                                                    ...
                                                    <div style={{marginBottom: "40px"}}>
                                                        <div className="rmc3-in3f">
                                                            ...
                                                            <div className="rmc3fs">
                                                                ...
                                                                <div className="rmc3fs-date"> 2022년 7월</div>
                                                            </div>
                                                        </div>
                                                        <div className="rmc3-ins">
                                                            <div style={{lineHeight: "24px"}}>
                                                                <span>
                                                                    <span className="ll4r2n">
                                                                        이곳은 녹음이 우거진 최고의 호텔이라고 말할 수 있습니다. 모든 직원들이 너무 친절합니다. 이곳은 시내에서 멀리 떨어져 있습니다. 이 주변에는 아무것도 없습니다. 하지만 너무나...
                                                                    </span>
                                                                </span>
                                                            </div>
                                                            <div className="rmc3-more">
                                                    ...
                                                    <div style={{marginBottom: "40px"}}>
                                                        ...
                                                        <div className="rmc3-ins">
                                                            <div style={{lineHeight: "24px"}}>
                                                                <span>
                                                                    <span className="ll4r2n">
                                                                        집이 환상적입니다! 모든 것이 잘 정리되어 있고 시설이 잘 갖추어져 있으며, 정말 멋지고 아름다운 집입니다. 머무는 동안 최고의 경험을 했습니다. 직원이 매우 도움이 되며 필요한 모든... 
                                                                    </span>
                                                                </span>
                                                            </div>
                                                            <div className="rmc3-more">
                                                    ...
                                                    <div style={{marginBottom: "40px"}}>
                                                        ...
                                                        <div className="rmc3-ins">
                                                            <div style={{lineHeight: "24px"}}>Name
                                                                <span>
                                                                    <span className="ll4r2n">
                                                                        아우라 하우스에서 즐거운 시간을 보냈습니다. 정말 놀라운 곳입니다. 각 집은 동화에 나올 것 같은 독특한 그린 빌리지입니다!  서비스도 빠르고 친절했으며 식사도 맛있었습니다. 이곳에... 
                                                                    </span>
                                                                </span>
                                                            </div>
                                                            <div className="rmc3-more">
                                            ...
                                            <div className="stu4md" style={{marginTop: "0"}}>
                                                <button className="rmctt3in4-btn" aria-label="후기 143개 모두 보기, 모달 대화를 엽니다." type="button">후기 143개 모두 보기</button>
                                            </div>
                                        </div>
                                    </section>
                                </div>
                                            ...
                                            <div className="rmctt3in4-in31">
                                                ...
                                                <div className="rmctt3in4-in31t">
                                                    <div className="rmctt3in4-in31tinf">
                                                        <div style={{display: "flex", flexDirection: "column", width: "40px", backgroundColor: "#fff", boxShadow: "0px 6px 16px rbga(0,0,0,0.12)",
                                                        borderRadius: "8px"}}>
                                                    ...
                                                    <div style={{paddingLeft: "8px", paddingRight: "8px"}}>
                                                        <div>
                                                            <div className="rmc3in7f">
                                                                <div className="rmc3in7ff">Abiansemal, 발리, 인도네시아</div>
                                                            </div>
                                    ...
                                    <section>
                                        <div className="rmc3-in3f">
                                            <div className="rmc3ff" style={{width: "64px", height:"64px"}}>
                                                <Link to="https://www.airbnb.co.kr/login?redirect_url=/users/show/469233392" className="rmc3ff-a">
                                                    <img className="_9ofhsl12" aria-hidden="true" alt="Wayan님은 슈퍼호스트입니다. Wayan님에 대해 자세히 알아보세요." decoding="async" elementtiming="LCP-target" src="https://a0.muscache.com/im/pictures/user/237512e2-5c40-40e9-86de-6a7c84e6882b.jpg?im_w=240" data-original-uri="https://a0.muscache.com/im/pictures/user/237512e2-5c40-40e9-86de-6a7c84e6882b.jpg?im_w=240" style={{objectFit: "cover", verticalAlign: "bottom"}}/>
                                                </Link>
                                                <div className="rmctt3-etc">
                                                <Etc />
                                                </div>                                                            
                                            ...
                                            <div className="rmc3fs">
                                                <h2 style={{margin: "0"}}>호스트: Wayan님</h2>
                                                <div className="rmc3fs-date" style={{paddingTop: "8px", color: "#717171"}}>회원 가입일: 2019년 2월
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div style={{paddingRight:"8px", paddingLeft: "8px"}}>
                                                <div className="rmc3in3s1">
                                                    <div className="rmc3in3s1f">
                                                        ...
                                                        <div className="rmc3in3s1f-txt">후기 438개</div>
                                                    </div>
                                                    <div className="rmc3in3s1f">
                                                        <div className="rmc3in3s1f-img">
                                                            <Certific />
                                                        </div>
                                                        <div className="rmc3in3s1f-txt">본인 인증 완료</div>
                                                    </div>
                                                    <div className="rmc3in3s1f">
                                                        <div className="rmc3in3s1f-img">
                                                            <span className="_8tbpu3" aria-hidden="true">󰀃</span>
                                                        </div>
                                                        <div className="rmc3in3s1f-txt">슈퍼호스트</div>
                                                    </div>
                                                </div>
                                                <div className="rmc3in3s2">
                                                    <div className="rmc3in3s2-tit">Wayan님은 슈퍼호스트입니다.</div>
                                                    <div className="rmc3in3s2-txt">슈퍼호스트는 풍부한 경험과 높은 평점을 자랑하며 게스트가 숙소에서 편안히 머무를 수 있도록 최선을 다하는 호스트입니다.</div>
                                                </div>
                                                <div className="rmc3in3s3">
                                                    <div className="rmc3in3s3-txt">응답률: 100%</div>
                                                    <div className="rmc3in3s3-txt">응답 시간: 1시간 이내</div>
                                                </div>
                                                <div className="rmc3in3s4">
                                                    <div className="stu4md" style={{marginTop: "0"}}>
                                                        <button className="rmctt3in4-btn" type="button">호스트에게 연락하기</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="rmctt3-in8">
                                            <div className="rmctt3-in8f">
                                                ...
                                                <div className="rmctt3-in8ss">
                                                    ...
                                                    <div style={{fontSize:"16px", fontWeight: "600", lineHeight: "20px", marginBottom: "12px"}}>숙소 이용규칙</div>
                                            ...
                                            <div className="rmctt3-in8f">
                                                <div>
                                                    <div className="rmctt3-in8ss">
                                                        <div style={{marginBottom: "12px"}}>
                                                        <div style={{fontSize:"16px", fontWeight: "600", lineHeight: "20px", marginBottom: "12px"}}>건강과 안전</div>
                                                        <div className="rmctt3in8s">
                                                            <div className="rmctt3in8s-img">
                                                                <span className="_8tbpu3" style={{marginRight: "16.8px;"}} aria-hidden="true">󹀁</span>
                                                            </div>
                                                            <div className="rmctt3in8s-txt">
                                                        ...
                                                        <div className="rmctt3in8s">
                                                            <div className="rmctt3in8s-img">
                                                                <span className="_8tbpu3" style={{marginRight: "16.8px"}} aria-hidden="true">󱠆</span>
                                                            </div>
                                                            <span className="rmctt3in8s-txt">
                                                                일산화탄소 경보기 설치 여부 정보 없음
                                                                <Link to="https://www.airbnb.co.kr/login?redirect_url=/users/show/469233392" target="_blank" className="bi61u5q v18vkvko dir dir-ltr">더 보기</Link>
                                                            </span>
                                                        </div>
                                                        <div className="rmctt3in8s">
                                                            <div className="rmctt3in8s-img">
                                            ...
                                            <div className="rmctt3-in8f">
                                                <div>
                                                    <div className="rmctt3-in8ss">
                                                        <div style={{marginBottom: "12px"}}>
                                                        <div style={{fontSize:"16px", fontWeight: "600", lineHeight: "20px", marginBottom: "12px"}}>환불 정책</div>
                                                        <div className="rmctt3in8s">
                                                            <div className="rmctt3in8s-txt">
                                                                7월 13일 전까지 무료로 취소하실 수 있습니다.
                                                            </div>
                                                        </div>
